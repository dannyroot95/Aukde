...
public class TinyDB {
    ...
    public String putImageCategories(String theFolder, String theImageName, Bitmap theBitmap) {
        if (theFolder == null || theImageName == null || theBitmap == null)
            return null;

        this.DEFAULT_APP_IMAGEDATA_DIRECTORY = "categories";
        String mFullPath = setupFullPath(theImageName);
    ...
    public void putListSlider(String key, ArrayList<Slider> list){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Slider slider: list){
            objStrings.add(gson.toJson(slider));
        }
        putListString(key, objStrings);
    }

    //No need Class<?> mClass parameter. Because we know it is Player!
    public ArrayList<Slider> getListSlider(String key, Class<Slider> java){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Slider slider  = gson.fromJson(jObjString,  Slider.class);
    ...
    public void putListCategories(String key, ArrayList<Categories> list){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Categories categories: list){
            objStrings.add(gson.toJson(categories));
        }
        putListString(key, objStrings);
    }

    //No need Class<?> mClass parameter. Because we know it is Player!
    public ArrayList<Categories> getListCategories(String key, Class<Categories> java){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Categories categories  = gson.fromJson(jObjString,  Categories.class);
